...
const T = {
  fr: {
    ...
    corp_label: 'Entreprises & Groupes',
    corp_title: 'Déplacements <em class="gold">d\'entreprise</em> sur mesure',
    corp_desc: 'Transport de votre personnel, accueil de vos clients VIP, navettes pour séminaires et événements — chaque besoin professionnel mérite une offre dédiée, avec facturation entreprise et chauffeurs attitrés.',
    corp_feat1: 'Navettes & transferts pour le personnel',
    corp_feat2: 'Accueil VIP de vos clients & partenaires',
    corp_feat3: 'Séminaires, congrès & événements',
    corp_feat4: 'Facturation entreprise & compte dédié',
    corp_feat5: 'Chauffeurs attitrés & discrétion garantie',
    corp_promise: 'Réponse en moins d\'une minute',
    corp_card_title: 'Devis personnalisé',
    corp_card_sub: 'Décrivez votre besoin : un conseiller dédié vous recontacte immédiatement avec une offre adaptée.',
    corp_cta_wa: 'Devis sur WhatsApp',
    corp_cta_email: 'Devis par email',
    corp_note: 'Conseiller dédié disponible 7j/7 · Confidentialité assurée',
    // Hero
    ...
    inc_title: 'Inclus dans chaque transfert',
    inc_sub: 'Le prix affiché est tout compris — aucun supplément caché.',
    inc_meet: 'Accueil personnalisé & pancarte à votre nom',
    inc_wait: 'Jusqu\'à 60 min d\'attente offertes à l\'aéroport',
    inc_cancel: 'Annulation gratuite jusqu\'à 1 h avant',
    inc_charger: 'Chargeurs iOS & Android à bord',
    inc_water: 'Eau fraîche offerte',
    inc_tracking: 'Suivi du chauffeur en direct sur WhatsApp',
    ...
    pay_online_btn: 'Payer en ligne maintenant',
    pay_cash_btn: 'Confirmer & payer en espèces',
    pay_cash_note: 'Paiement en espèces remis au chauffeur le jour J.',
  ...
  en: {
    ...
    nav_corporate: 'Business',
    corp_label: 'Companies & Groups',
    corp_title: 'Tailored <em class="gold">corporate</em> travel',
    corp_desc: 'Transporting your staff, welcoming your VIP clients, shuttles for seminars and events — every professional need deserves a dedicated offer, with corporate billing and assigned chauffeurs.',
    corp_feat1: 'Shuttles & transfers for staff',
    corp_feat2: 'VIP welcome for your clients & partners',
    corp_feat3: 'Seminars, conferences & events',
    corp_feat4: 'Corporate billing & dedicated account',
    corp_feat5: 'Assigned chauffeurs & guaranteed discretion',
    corp_promise: 'Reply in under a minute',
    corp_card_title: 'Custom quote',
    corp_card_sub: 'Describe your need: a dedicated advisor gets back to you immediately with a tailored offer.',
    corp_cta_wa: 'Quote via WhatsApp',
    corp_cta_email: 'Quote via email',
    corp_note: 'Dedicated advisor available 7/7 · Confidentiality assured',
    ...
    inc_title: 'Included in every transfer',
    inc_sub: 'The price shown is all-inclusive — no hidden fees.',
    inc_meet: 'Personal meet & greet with a name sign',
    inc_wait: 'Up to 60 min free airport waiting time',
    inc_cancel: 'Free cancellation up to 1 hour before',
    inc_charger: 'iOS & Android chargers on board',
    inc_water: 'Complimentary fresh water',
    inc_tracking: 'Live driver tracking on WhatsApp',
    ...
    pay_online_btn: 'Pay online now',
    pay_cash_btn: 'Confirm & pay in cash',
    pay_cash_note: 'Cash payment handed to the driver on the day.',
